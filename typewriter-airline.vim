let g:airline#themes#typewriter#palette = {}

function! airline#themes#typewriter#refresh()
  let g:airline#themes#typewriter#palette.accents = {
  ...
  let g:airline#themes#typewriter#palette.normal_modified = {
  ...
  let s:I3 = s:N3
  let g:airline#themes#typewriter#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
  let g:airline#themes#typewriter#palette.insert_modified = g:airline#themes#typewriter#palette.normal_modified

  let s:R1 = airline#themes#get_highlight('Error', 'bold')
  let s:R2 = s:N2
  let s:R3 = s:N3
  let g:airline#themes#typewriter#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
  let g:airline#themes#typewriter#palette.replace_modified = g:airline#themes#typewriter#palette.normal_modified
